...
import javax.swing.*;
import java.sql.*;
public class Index extends Frame implements ActionListener
{
    JLabel l1,l2,l3,l4;
    JButton bt1,bt2;
    JPanel p1,p2,p3;
    ...
    Index()
    {
      super("Home Page");
        ...
        ImageIcon i=new ImageIcon(ClassLoader.getSystemResource("feereportmanagement/icons/images.jfif"));
