...
public class AddStudent extends JFrame implements ActionListener {
    ...
    
    {
      ...
      if(e.getSource()==bt1)
      {
          ...
          String q="insert into add_student(name,email,course,fee,paid,due,addrs,city,state,country,mob)value('"+name+"','"+email+"','"+course+"','"+fee+"','"+paid+"','"+due+"','"+address+"','"+city+"','"+state+"','"+country+"','"+contact+"')";
          int aa=obj.st.executeUpdate(q);
          if(aa==1)
          {
