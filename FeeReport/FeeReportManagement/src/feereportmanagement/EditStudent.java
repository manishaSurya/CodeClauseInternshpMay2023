...
public class EditStudent extends JFrame implements ActionListener  {
        ...
        ch.addMouseListener(new MouseAdapter()
        {
            ...
            public void mouseClicked(MouseEvent arg0)
            {
                try
                {
                    ...
                    String q1="Select*from add_student where rollno='"+roll+"' "; 
                    ResultSet rs1=obj1.st.executeQuery(q1);
                    while(rs1.next())
                    {
    ...
    public void actionPerformed(ActionEvent e)
    {
      ...
      if(e.getSource()==bt1)
      {
          ...
          String q="update add_student set name='"+name+"',email='"+email+"',course='"+course+"',fee='"+fee+"',paid='"+paid+"',due='"+due+"',addrs='"+address+"',city='"+city+"',state='"+state+"',country='"+country+"',mob='"+contact+"'where rollno='"+roll+"'";
          int aa=obj2.st.executeUpdate(q);
          if(aa==1)
          {
